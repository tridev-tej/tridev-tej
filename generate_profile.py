...
INFO = [
    ...
    kv("IDE:", ("VS Code, Cursor, Claude Code", C_VAL)),
    [],
    header("- Runtime"),
    kv("Languages.Programming:", ("Python, C++, TypeScript, SQL", C_VAL)),
    kv("Stack.Backend:", ("Django, FastAPI, Node.js, Redis", C_VAL)),
    kv("Stack.Frontend:", ("React, Tailwind, Shadcn/UI", C_VAL)),
    kv("Stack.DevOps:", ("Docker, K8s, AWS, Jenkins", C_VAL)),
    kv("Languages.Real:", ("English, Hindi", C_VAL)),
    [],
    header("- Career"),
    kv("Education:", ("IIT Kanpur, B.Tech CSE (9.14)", C_VAL)),
    kv("History:", ("Simbian, Abacus.AI, TI, Securonix", C_VAL)),
    kv("CP.Ratings:", ("LeetCode 1850+, CodeChef 1750+", C_VAL)),
    kv("Side.Project:", ("Homeo-AI (1000+ users)", C_VAL)),
    [],
    header("- Contact"),
